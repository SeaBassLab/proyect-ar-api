...
import ObjInterface from '../../../Domain/Entities/Course/Interface'
import Serviceable from '../../../Domain/Entities/Course/Ports/Serviceable'
...
export default class Controller implements Routeable, Patheable {
	...
	@inject(TYPES.Validable) @named(TYPES.Course) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Course) private schema: Schemable
	@inject(TYPES.Schemable) @named(TYPES.User) private userSchema: Schemable
	@inject(TYPES.Schemable) @named(TYPES.Student) private studentSchema: Schemable
	@inject(TYPES.CourseServiceableDomain) private service: Serviceable
