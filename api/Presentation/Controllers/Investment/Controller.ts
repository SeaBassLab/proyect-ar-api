...
import Dto from '../../../Domain/Entities/Investment/Dto'
import ObjInterface from '../../../Domain/Entities/Investment/Interface'
import Serviceable from '../../../Domain/Entities/Investment/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/investment'
	...
	@inject(TYPES.Validable) @named(TYPES.Investment) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Investment) private schema: Schemable
	@inject(TYPES.InvestmentServiceableDomain) private service: Serviceable
