...
import Dto from '../../../Domain/Entities/Transfer/Dto'
import ObjInterface from '../../../Domain/Entities/Transfer/Interface'
import Serviceable from '../../../Domain/Entities/Transfer/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/transfer'
	...
	@inject(TYPES.Validable) @named(TYPES.Transfer) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Transfer) private schema: Schemable
	@inject(TYPES.TransferServiceableDomain) private service: Serviceable
