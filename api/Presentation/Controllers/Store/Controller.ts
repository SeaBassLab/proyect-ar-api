...
import Dto from "../../../Domain/Entities/Store/Dto";
import ObjInterface from "../../../Domain/Entities/Store/Interface";
import Serviceable from "../../../Domain/Entities/Store/Ports/Serviceable";

@injectable()
export default class Controller implements Routeable, Patheable {
    public router: Router = container.get<Router>(TYPES.Router);
    public path: string = "/store";
    ...
    @inject(TYPES.Validable) @named(TYPES.Store) private dto: Validable;
    @inject(TYPES.Schemable) @named(TYPES.Store) private schema: Schemable;
    @inject(TYPES.StoreServiceableDomain) private service: Serviceable;
