...
import Dto from '../../../Domain/Entities/Entity/Dto'
import ObjInterface from '../../../Domain/Entities/Entity/Interface'
import Serviceable from '../../../Domain/Entities/Entity/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/entity'
	...
	@inject(TYPES.Validable) @named(TYPES.Entity) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Entity) private schema: Schemable
	@inject(TYPES.EntityServiceableDomain) private service: Serviceable
