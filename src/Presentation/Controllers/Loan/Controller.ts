...
import Dto from '../../../Domain/Entities/Loan/Dto'
import ObjInterface from '../../../Domain/Entities/Loan/Interface'
import Serviceable from '../../../Domain/Entities/Loan/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/loan'
	...
	@inject(TYPES.Validable) @named(TYPES.Loan) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Loan) private schema: Schemable
	@inject(TYPES.LoanServiceableDomain) private service: Serviceable
