...
import ObjInterface from "../../../Domain/Entities/Plan/Interface";
import Serviceable from "../../../Domain/Entities/Plan/Ports/Serviceable";

@injectable()
export default class Controller implements Routeable, Patheable {
    public router: Router = container.get<Router>(TYPES.Router);
    public path: string = "/plan";
    ...
    @inject(TYPES.Validable) @named(TYPES.Plan) private dto: Validable;
    @inject(TYPES.Schemable) @named(TYPES.Plan) private schema: Schemable;
    @inject(TYPES.PlanServiceableDomain) private service: Serviceable;
    ...
    initializeRoutes(validationProvider: Validateable) {
        this.router
            ...
            .get(`${this.path}/withauth`, [], this.getAllObjsWithAuth)
            .get(
                `${this.path}/schema`,
            ...
            .post(
                ...
                [
                    this.authMid.authenticate,
                    validationProvider.validate(this.dto),
                ],
                this.saveObj
            )
            .put(
                ...
                [
                    this.authMid.authenticate,
                    validationProvider.validate(this.dto, true),
                ],
                this.updateObj
            )
            .delete(
    ...
    private getAllObjsWithAuth = async (
        request: RequestWithUser,
        response: Response,
        next: NextFunction
    ) => {
        let db: any = request.query.db;
