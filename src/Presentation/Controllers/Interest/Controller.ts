...
import Dto from '../../../Domain/Entities/Interest/Dto'
import ObjInterface from '../../../Domain/Entities/Interest/Interface'
import Serviceable from '../../../Domain/Entities/Interest/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/interest'
	...
	@inject(TYPES.Validable) @named(TYPES.Interest) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Interest) private schema: Schemable
	@inject(TYPES.InterestServiceableDomain) private service: Serviceable
