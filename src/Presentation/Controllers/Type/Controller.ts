...
import ObjInterface from "../../../Domain/Entities/Type/Interface";
import Serviceable from "../../../Domain/Entities/Type/Ports/Serviceable";
...
export default class Controller implements Routeable, Patheable {
    ...
    @inject(TYPES.Validable) @named(TYPES.Type) private dto: Validable;
    @inject(TYPES.Schemable) @named(TYPES.Type) private schema: Schemable;
    @inject(TYPES.TypeServiceableDomain) private service: Serviceable;
