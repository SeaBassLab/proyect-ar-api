...
import Dto from '../../../Domain/Entities/Movement/Dto'
import ObjInterface from '../../../Domain/Entities/Movement/Interface'
import Serviceable from '../../../Domain/Entities/Movement/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/movement'
	...
	@inject(TYPES.Validable) @named(TYPES.Movement) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Movement) private schema: Schemable
	@inject(TYPES.MovementServiceableDomain) private service: Serviceable
