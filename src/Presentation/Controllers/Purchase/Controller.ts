...
import Dto from '../../../Domain/Entities/Purchase/Dto'
import ObjInterface from '../../../Domain/Entities/Purchase/Interface'
import Serviceable from '../../../Domain/Entities/Purchase/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/purchase'
	...
	@inject(TYPES.Validable) @named(TYPES.Purchase) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Purchase) private schema: Schemable
	@inject(TYPES.PurchaseServiceableDomain) private service: Serviceable
