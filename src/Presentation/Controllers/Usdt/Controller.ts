...
import Dto from '../../../Domain/Entities/Usdt/Dto'
import ObjInterface from '../../../Domain/Entities/Usdt/Interface'
import Serviceable from '../../../Domain/Entities/Usdt/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/usdt'
	...
	@inject(TYPES.Validable) @named(TYPES.Usdt) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Usdt) private schema: Schemable
	@inject(TYPES.UsdtServiceableDomain) private service: Serviceable
