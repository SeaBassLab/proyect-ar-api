...
import Dto from "../../../Domain/Entities/Strain/Dto";
import ObjInterface from "../../../Domain/Entities/Strain/Interface";
import Serviceable from "../../../Domain/Entities/Strain/Ports/Serviceable";

@injectable()
export default class Controller implements Routeable, Patheable {
    public router: Router = container.get<Router>(TYPES.Router);
    public path: string = "/strain";
    ...
    @inject(TYPES.Validable) @named(TYPES.Strain) private dto: Validable;
    @inject(TYPES.Schemable) @named(TYPES.Strain) private schema: Schemable;
    @inject(TYPES.StrainServiceableDomain) private service: Serviceable;
    ...
    initializeRoutes(validationProvider: Validateable) {
        this.router
            ...
            .post(
                this.path,
                [this.authMid.authenticate, validationProvider.validate(Dto)],
                this.saveObj
            )
            .put(
                `${this.path}/:id`,
