...
import Dto from '../../../Domain/Entities/Wire/Dto'
import ObjInterface from '../../../Domain/Entities/Wire/Interface'
import Serviceable from '../../../Domain/Entities/Wire/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/wire'
	...
	@inject(TYPES.Validable) @named(TYPES.Wire) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Wire) private schema: Schemable
	@inject(TYPES.WireServiceableDomain) private service: Serviceable
