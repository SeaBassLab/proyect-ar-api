...
import Dto from '../../../Domain/Entities/Check/Dto'
import ObjInterface from '../../../Domain/Entities/Check/Interface'
import Serviceable from '../../../Domain/Entities/Check/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/check'
	...
	@inject(TYPES.Validable) @named(TYPES.Check) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Check) private schema: Schemable
	@inject(TYPES.CheckServiceableDomain) private service: Serviceable
