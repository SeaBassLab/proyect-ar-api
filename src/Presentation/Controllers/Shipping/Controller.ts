...
import ObjInterface from "../../../Domain/Entities/Shipping/Interface";
import Serviceable from "../../../Domain/Entities/Shipping/Ports/Serviceable";

@injectable()
export default class Controller implements Routeable, Patheable {
    public router: Router = container.get<Router>(TYPES.Router);
    public path: string = "/shipping";
    ...
    @inject(TYPES.Validable) @named(TYPES.Shipping) private dto: Validable;
    @inject(TYPES.Schemable) @named(TYPES.Shipping) private schema: Schemable;
    @inject(TYPES.ShippingServiceableDomain) private service: Serviceable;
