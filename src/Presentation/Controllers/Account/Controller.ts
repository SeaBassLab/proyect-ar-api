...
import Dto from '../../../Domain/Entities/Account/Dto'
import ObjInterface from '../../../Domain/Entities/Account/Interface'
import Serviceable from '../../../Domain/Entities/Account/Ports/Serviceable'
...
export default class Controller implements Routeable, Patheable {
	...
	@inject(TYPES.Validable) @named(TYPES.Account) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Account) private schema: Schemable
	@inject(TYPES.AccountServiceableDomain) private service: Serviceable
