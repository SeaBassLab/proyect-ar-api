...
import ObjInterface from "../../../Domain/Entities/Code/Interface";
import Serviceable from "../../../Domain/Entities/Code/Ports/Serviceable";

@injectable()
export default class Controller implements Routeable, Patheable {
    public router: Router = container.get<Router>(TYPES.Router);
    public path: string = "/code";
    ...
    @inject(TYPES.Validable) @named(TYPES.Code) private dto: Validable;
    @inject(TYPES.Schemable) @named(TYPES.Code) private schema: Schemable;
    @inject(TYPES.CodeServiceableDomain) private service: Serviceable;
