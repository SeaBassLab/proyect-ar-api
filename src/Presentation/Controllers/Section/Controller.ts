...
import Dto from '../../../Domain/Entities/Section/Dto'
import ObjInterface from '../../../Domain/Entities/Section/Interface'
import Serviceable from '../../../Domain/Entities/Section/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/section'
	...
	@inject(TYPES.Validable) @named(TYPES.Section) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Section) private schema: Schemable
	@inject(TYPES.SectionServiceableDomain) private service: Serviceable
