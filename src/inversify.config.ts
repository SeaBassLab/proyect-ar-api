...
import ConfigurationContainer from './Presentation/Controllers/Configuration/inversify'
import BlueContainer from './Presentation/Controllers/Blue/inversify'
import UsdtContainer from './Presentation/Controllers/Usdt/inversify'
import WireContainer from './Presentation/Controllers/Wire/inversify'
import InvestmentContainer from './Presentation/Controllers/Investment/inversify'
import TransferContainer from './Presentation/Controllers/Transfer/inversify'
import CheckContainer from './Presentation/Controllers/Check/inversify'
import AccountContainer from './Presentation/Controllers/Account/inversify'
import MovementContainer from './Presentation/Controllers/Movement/inversify'
import InterestContainer from './Presentation/Controllers/Interest/inversify'
import LoanContainer from './Presentation/Controllers/Loan/inversify'
import BoxContainer from './Presentation/Controllers/Box/inversify'
import ItemContainer from './Presentation/Controllers/Item/inversify'
import PurchaseContainer from './Presentation/Controllers/Purchase/inversify'
import SaleContainer from './Presentation/Controllers/Sale/inversify'
import PlanContainer from './Presentation/Controllers/Plan/inversify'
import ShippingContainer from './Presentation/Controllers/Shipping/inversify'
import CodeContainer from './Presentation/Controllers/Code/inversify'
import StrainContainer from './Presentation/Controllers/Strain/inversify'
import TypeContainer from './Presentation/Controllers/Type/inversify'
import StoreContainer from './Presentation/Controllers/Store/inversify'
import InformationContainer from './Presentation/Controllers/Information/inversify'
import TagContainer from './Presentation/Controllers/Tag/inversify'
import SectionContainer from './Presentation/Controllers/Section/inversify'
// containerimport
...
containerReturn = Container.merge(containerReturn, ConfigurationContainer)
containerReturn = Container.merge(containerReturn, BlueContainer)
containerReturn = Container.merge(containerReturn, UsdtContainer)
containerReturn = Container.merge(containerReturn, WireContainer)
containerReturn = Container.merge(containerReturn, InvestmentContainer)
containerReturn = Container.merge(containerReturn, TransferContainer)
containerReturn = Container.merge(containerReturn, CheckContainer)
containerReturn = Container.merge(containerReturn, AccountContainer)
containerReturn = Container.merge(containerReturn, MovementContainer)
containerReturn = Container.merge(containerReturn, InterestContainer)
containerReturn = Container.merge(containerReturn, LoanContainer)
containerReturn = Container.merge(containerReturn, BoxContainer)
containerReturn = Container.merge(containerReturn, ItemContainer)
containerReturn = Container.merge(containerReturn, PurchaseContainer)
containerReturn = Container.merge(containerReturn, SaleContainer)
containerReturn = Container.merge(containerReturn, PlanContainer)
containerReturn = Container.merge(containerReturn, ShippingContainer)
containerReturn = Container.merge(containerReturn, CodeContainer)
containerReturn = Container.merge(containerReturn, StrainContainer)
containerReturn = Container.merge(containerReturn, TypeContainer)
containerReturn = Container.merge(containerReturn, StoreContainer)
containerReturn = Container.merge(containerReturn, InformationContainer)
containerReturn = Container.merge(containerReturn, TagContainer)
containerReturn = Container.merge(containerReturn, SectionContainer)
// push
