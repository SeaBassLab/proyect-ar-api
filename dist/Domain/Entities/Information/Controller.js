...
var Controller = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_TYPES["default"].ResponseableDomain), _dec3 = (0, _inversify.inject)(_TYPES["default"].Updateable), _dec4 = (0, _inversify.inject)(_TYPES["default"].GeteableAll), _dec5 = (0, _inversify.inject)(_TYPES["default"].GeteableById), _dec6 = (0, _inversify.inject)(_TYPES["default"].Saveable), _dec(_class = (_class2 = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(Controller, [{
    ...
    key: "getAll",
    value: function () {
      var _getAll = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee9(informationModel, project, match, sort, group, limit, skip, strainModel) {
        var _this4 = this;
                    ...
                    return _regenerator["default"].wrap(function _callee8$(_context8) {
                      while (1) {
                        switch (_context8.prev = _context8.next) {
                          case 0:
                            _context8.next = 2;
                            return _this4.geteableAllService.getAll(informationModel, project, match, sort, group, limit, skip).then( /*#__PURE__*/function () {
                              var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee7(result) {
                                var strainList, matchStrain;
                                  ...
                                  while (1) {
                                    switch (_context7.prev = _context7.next) {
                                      case 0:
                                        ...
                                        if (!(result.result !== undefined && result.result !== null && result.result[0] !== undefined && result.result[0] !== null && result.result[0].items !== undefined && result.result[0].items !== null && Array.isArray(result.result[0].items) && result.result[0].items.length > 0)) {
                                          _context7.next = 11;
                                          break;
                                        }

                                        strainList = [];
                                        result.result[0].items.map(function (information) {
                                          strainList.push({
                                        ...
                                        _context7.next = 7;
                                        return _this4.getAll(strainModel, {
                                          name: 1,
                                          _id: 1
                                        }, matchStrain, {}, {}, 0, 0);
                                      ...
                                      case 7:
                                        _context7.next = 9;
                                        return _context7.sent.result;

                                      case 9:
                                        strainList = _context7.sent;
                                        result.result[0].items.map(function (information) {
                                          strainList.map(function (strain) {
      ...
      function getAll(_x16, _x17, _x18, _x19, _x20, _x21, _x22, _x23) {
