...
var Controller = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_TYPES["default"].ResponseableDomain), _dec3 = (0, _inversify.inject)(_TYPES["default"].Updateable), _dec4 = (0, _inversify.inject)(_TYPES["default"].GeteableAll), _dec5 = (0, _inversify.inject)(_TYPES["default"].GeteableById), _dec6 = (0, _inversify.inject)(_TYPES["default"].Saveable), _dec(_class = (_class2 = /*#__PURE__*/function () {
  ...
  _createClass(Controller, [{
    key: "getByStudent",
    value: function () {
      var _getByStudent = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(model, studentMmodel, userModel, idUser) {
        var _this = this;
                      ...
                      while (1) {
                        switch (_context3.prev = _context3.next) {
                          case 0:
                            ...
                            _context3.next = 3;
                            return _this.geteableAllService.getAll(studentMmodel, {}, match, {}, {}, 1, 0).then( /*#__PURE__*/function () {
                                    ...
                                    switch (_context2.prev = _context2.next) {
                                      case 0:
                                        ...
                                        _match = {
                                          ...
                                          _id: {
                                            $oid: res.result.course
                                          }
                                        };
                                        _context2.next = 4;
                                        return _this.geteableAllService.getAll(model, {}, _match, {}, {}, 0, 0).then( /*#__PURE__*/function () {
      ...
      function getByStudent(_x, _x2, _x3, _x4) {
        return _getByStudent.apply(this, arguments);
      }
    ...
    key: "update",
    value: function () {
      var _update = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(id, data, model, idUser) {
        var _this2 = this;
    ...
    key: "getById",
    value: function () {
      var _getById = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(id, model) {
        var _this3 = this;
    ...
    key: "save",
    value: function () {
      var _save = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(data, model, idUser) {
        var _this4 = this;
    ...
    key: "getAll",
    value: function () {
      var _getAll = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(model, project, match, sort, group, limit, skip) {
        var _this5 = this;
            ...
            switch (_context12.prev = _context12.next) {
              case 0:
                return _context12.abrupt("return", new Promise( /*#__PURE__*/function () {
                  var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(resolve, reject) {
                    return regeneratorRuntime.wrap(function _callee11$(_context11) {
                      while (1) {
                        switch (_context11.prev = _context11.next) {
                          case 0:
                            _context11.next = 2;
                            return _this5.geteableAllService.getAll(model, project, match, sort, group, limit, skip).then(function (result) {
                              if (result) {
      ...
      function getAll(_x24, _x25, _x26, _x27, _x28, _x29, _x30) {
