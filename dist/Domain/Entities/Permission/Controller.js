...
var Controller = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_TYPES["default"].ResponseableDomain), _dec3 = (0, _inversify.inject)(_TYPES["default"].Updateable), _dec4 = (0, _inversify.inject)(_TYPES["default"].GeteableAll), _dec5 = (0, _inversify.inject)(_TYPES["default"].GeteableById), _dec6 = (0, _inversify.inject)(_TYPES["default"].Saveable), _dec(_class = (_class2 = /*#__PURE__*/function () {
  ...
  _createClass(Controller, [{
    ...
    key: "getByUser",
    value: function () {
      var _getByUser = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(model, userModel, userId) {
        var _this5 = this;
            ...
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                return _context11.abrupt("return", new Promise( /*#__PURE__*/function () {
                  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(resolve, reject) {
                    var project;
                      ...
                      while (1) {
                        switch (_context10.prev = _context10.next) {
                          case 0:
                            ...
                            _context10.next = 3;
                            return _this5.geteableAllService.getAll(userModel, project, match, {}, {}, 1, 0).then( /*#__PURE__*/function () {
                              var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(result) {
                                var _result$result, _result$result$rol;
                                      ...
                                      case 0:
                                        if (result) {
                                          _this5.responserService = {
                                            result: ((_result$result = result.result) === null || _result$result === void 0 ? void 0 : (_result$result$rol = _result$result.rol) === null || _result$result$rol === void 0 ? void 0 : _result$result$rol.permission) || [],
                                            message: result.message,
                                            error: result.error,
                                            status: result.status
                                          };
      ...
      function getByUser(_x25, _x26, _x27) {
