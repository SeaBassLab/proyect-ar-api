...
var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11;
...
var Controller = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_TYPES["default"].ConnectionableProvider), _dec3 = (0, _inversify.inject)(_TYPES["default"].Responseable), _dec4 = (0, _inversify.inject)(_TYPES["default"].Validable), _dec5 = (0, _inversify.named)(_TYPES["default"].Student), _dec6 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec7 = (0, _inversify.named)(_TYPES["default"].Student), _dec8 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec9 = (0, _inversify.named)(_TYPES["default"].User), _dec10 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec11 = (0, _inversify.named)(_TYPES["default"].Company), _dec12 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec13 = (0, _inversify.named)(_TYPES["default"].Session), _dec14 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec15 = (0, _inversify.named)(_TYPES["default"].Mail), _dec16 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec17 = (0, _inversify.named)(_TYPES["default"].Subscription), _dec18 = (0, _inversify.inject)(_TYPES["default"].StudentServiceableDomain), _dec19 = (0, _inversify.inject)(_TYPES["default"].Authenticable), _dec(_class = (_class2 = /*#__PURE__*/function () {
  function Controller() {
    var _this = this;
    ...
    _defineProperty(this, "path", '/student');
    ...
    _initializerDefineProperty(this, "service", _descriptor10, this);

    _initializerDefineProperty(this, "authenticationService", _descriptor11, this);
    ...
    _defineProperty(this, "saveObj", /*#__PURE__*/function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(request, response, next) {
        var model, userModel, subscriptionModel, mailModel, sessionModel, companyModel, objData, id, user;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 2:
                ...
                _context6.next = 5;
                return _this.connectionProvider.getModel(request.database, _this.userSchema.name, _this.userSchema);
              ...
              case 11:
                ...
                _context6.next = 14;
                return _this.connectionProvider.getModel(request.database, _this.sessionSchema.name, _this.sessionSchema);
              ...
              case 17:
                ...
                user = {
                  ...
                  email: objData.mail,
                  name: objData.name,
                  rol: '60101e7dea5ee92711841091'
                };
                _context6.next = 23;
                return _this.authenticationService.register(user, request.database, userModel, companyModel, mailModel, subscriptionModel).then( /*#__PURE__*/function () {
                  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(res) {
                    return regeneratorRuntime.wrap(function _callee5$(_context5) {
                      while (1) {
                        switch (_context5.prev = _context5.next) {
                          case 0:
                            objData.userId = res.result.user._id;
                            _context5.next = 3;
    ...
    _defineProperty(this, "updateObj", /*#__PURE__*/function () {
      var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(request, response, next) {
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 2:
                ...
                _context10.next = 7;
                return _this.service.getById(id, model).then( /*#__PURE__*/function () {
                  var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(getObjById) {
                    var obj;
  ...
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "userSchema", [_dec8, _dec9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "companySchema", [_dec10, _dec11], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "sessionSchema", [_dec12, _dec13], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "mailSchema", [_dec14, _dec15], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "subscriptionSchema", [_dec16, _dec17], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "service", [_dec18], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "authenticationService", [_dec19], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
