...
var Controller = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_TYPES["default"].ConnectionableProvider), _dec3 = (0, _inversify.inject)(_TYPES["default"].Responseable), _dec4 = (0, _inversify.inject)(_TYPES["default"].Validable), _dec5 = (0, _inversify.named)(_TYPES["default"].Quiz), _dec6 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec7 = (0, _inversify.named)(_TYPES["default"].Quiz), _dec8 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec9 = (0, _inversify.named)(_TYPES["default"].QuestionQuiz), _dec10 = (0, _inversify.inject)(_TYPES["default"].QuizServiceableDomain), _dec11 = (0, _inversify.inject)(_TYPES["default"].QuestionQuizServiceableDomain), _dec(_class = (_class2 = /*#__PURE__*/function () {
  function Controller() {
    var _this = this;

    (0, _classCallCheck2["default"])(this, Controller);
    (0, _defineProperty2["default"])(this, "router", _inversify2["default"].get(_TYPES["default"].Router));
    (0, _defineProperty2["default"])(this, "path", '/quiz');
    ...
    (0, _initializerDefineProperty2["default"])(this, "questionQuizSchema", _descriptor5, this);
    (0, _initializerDefineProperty2["default"])(this, "service", _descriptor6, this);
    (0, _initializerDefineProperty2["default"])(this, "questionQuizService", _descriptor7, this);
    ...
    (0, _defineProperty2["default"])(this, "saveObj", /*#__PURE__*/function () {
      var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(request, response, next) {
        var model, questionQuizModel, objData, id, obj, questionList;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                ...
                _context5.next = 5;
                return _this.connectionProvider.getModel(request.database, _this.questionQuizSchema.name, _this.questionQuizSchema);

              case 5:
                questionQuizModel = _context5.sent;
                ...
                return _this.service.save(objData, model, id).then(function (res) {
                  if (res && res.result !== undefined) {
                    ...
                    questionList.map(function (question) {
                      ...
                      _this.questionQuizService.save(questionQuiz, questionQuizModel, id);
                    });
                    _this.responserService.res = {
                      result: res.result,
                      message: res.message,
  ...
  writable: true,
  initializer: null
}), _descriptor5 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "questionQuizSchema", [_dec8, _dec9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
}), _descriptor7 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "questionQuizService", [_dec11], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
