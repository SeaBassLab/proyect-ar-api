...
var Controller = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_TYPES["default"].ConnectionableProvider), _dec3 = (0, _inversify.inject)(_TYPES["default"].Responseable), _dec4 = (0, _inversify.inject)(_TYPES["default"].Validable), _dec5 = (0, _inversify.named)(_TYPES["default"].Calibration), _dec6 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec7 = (0, _inversify.named)(_TYPES["default"].Calibration), _dec8 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec9 = (0, _inversify.named)(_TYPES["default"].Configuration), _dec10 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec11 = (0, _inversify.named)(_TYPES["default"].Instrument), _dec12 = (0, _inversify.inject)(_TYPES["default"].CalibrationServiceableDomain), _dec(_class = (_class2 = /*#__PURE__*/function () {
  function Controller() {
    var _this = this;

    (0, _classCallCheck2["default"])(this, Controller);
    (0, _defineProperty2["default"])(this, "router", _inversify2["default"].get(_TYPES["default"].Router));
    (0, _defineProperty2["default"])(this, "path", '/calibration');
    ...
    (0, _initializerDefineProperty2["default"])(this, "configurationSchema", _descriptor5, this);
    (0, _initializerDefineProperty2["default"])(this, "instrumentSchema", _descriptor6, this);
    ...
    (0, _defineProperty2["default"])(this, "saveObj", /*#__PURE__*/function () {
      var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(request, response, next) {
        var calibrationModel, configurationModel, instrumentModel, objData, id;
        return _regenerator["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                calibrationModel = _context5.sent;
                _context5.next = 5;
                return _this.connectionProvider.getModel(request.database, _this.configurationSchema.name, _this.configurationSchema);

              case 5:
                configurationModel = _context5.sent;
                _context5.next = 8;
                return _this.connectionProvider.getModel(request.database, _this.instrumentSchema.name, _this.instrumentSchema);

              case 8:
                instrumentModel = _context5.sent;
                objData = request.body;
                id = request.user._id;
                _context5.next = 13;
                return _this.service.save(objData, calibrationModel, configurationModel, instrumentModel, id).then(function (res) {
                  if (res && res.result !== undefined) {
                    _this.responserService.res = {
                      result: res.result,
                      message: res.message,
  ...
  writable: true,
  initializer: null
}), _descriptor5 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "configurationSchema", [_dec8, _dec9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor6 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "instrumentSchema", [_dec10, _dec11], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
