...
var Controller = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_TYPES["default"].ConnectionableProvider), _dec3 = (0, _inversify.inject)(_TYPES["default"].Responseable), _dec4 = (0, _inversify.inject)(_TYPES["default"].Validable), _dec5 = (0, _inversify.named)(_TYPES["default"].Permission), _dec6 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec7 = (0, _inversify.named)(_TYPES["default"].Permission), _dec8 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec9 = (0, _inversify.named)(_TYPES["default"].User), _dec10 = (0, _inversify.inject)(_TYPES["default"].PermissionServiceableDomain), _dec(_class = (_class2 = /*#__PURE__*/function () {
  function Controller() {
    var _this = this;

    (0, _classCallCheck2["default"])(this, Controller);
    (0, _defineProperty2["default"])(this, "router", _inversify2["default"].get(_TYPES["default"].Router));
    (0, _defineProperty2["default"])(this, "path", '/permission');
    ...
    (0, _defineProperty2["default"])(this, "getBase", /*#__PURE__*/function () {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                _this.responserService.res = {
                  result: _config["default"].PERMISSIONS,
                  message: '',
                  status: 200,
                  error: null
                };
    ...
    (0, _defineProperty2["default"])(this, "getByUser", /*#__PURE__*/function () {
      var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(request, response, next) {
        var database, model, userModel, recivedUser;
        return _regenerator["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                database = '';
                if (request.query.database !== undefined) database = request.query.database;
                _context2.next = 4;
              ...
              case 7:
                ...
                recivedUser = '';
                if (request.query !== undefined) recivedUser = request.query.user;
                _context2.next = 12;
                return _this.service.getByUser(model, userModel, recivedUser).then(function (res) {
                  if (res && res.result !== undefined) {
                    if (res.result) {
                      _this.responserService.res = {
                        result: {
                          permissionList: res.result,
                          base: _config["default"].PERMISSIONS
                        },
                        message: res.message,
                        status: res.status,
                        error: res.error
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 2:
                ...
                _context9.next = 8;
                return _this.service.getById(id, model).then( /*#__PURE__*/function () {
                  var _ref9 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee8(res) {
    ...
    (0, _defineProperty2["default"])(this, "deleteObj", /*#__PURE__*/function () {
      var _ref10 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee11(request, response, next) {
        var model, id, idUser;
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 2:
                ...
                _context11.next = 7;
                return _this.service.getById(id, model).then( /*#__PURE__*/function () {
                  var _ref11 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee10(getObjById) {
                    var obj;
  ...
  (0, _createClass2["default"])(Controller, [{
    ...
    value: function initializeRoutes(validationProvider) {
      this.router.get(this.path, [this.authMid.authenticate], this.getBase).get("".concat(this.path, "/base"), [this.authMid.authenticate], this.getBase).get("".concat(this.path, "/by"), [], this.getByUser).get("".concat(this.path, "/schema"), [this.authMid.authenticate], this.getSchema).get("".concat(this.path, "/:id"), [this.authMid.authenticate], this.getObjById).post(this.path, [this.authMid.authenticate, validationProvider.validate(this.dto)], this.saveObj).put("".concat(this.path, "/:id"), [this.authMid.authenticate, validationProvider.validate(this.dto, true)], this.updateObj)["delete"]("".concat(this.path, "/:id"), [this.authMid.authenticate], this.deleteObj);
    }
  }]);
  return Controller;
