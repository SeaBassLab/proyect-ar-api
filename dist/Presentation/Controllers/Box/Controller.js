...
var Controller = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_TYPES["default"].ConnectionableProvider), _dec3 = (0, _inversify.inject)(_TYPES["default"].Responseable), _dec4 = (0, _inversify.inject)(_TYPES["default"].Validable), _dec5 = (0, _inversify.named)(_TYPES["default"].Box), _dec6 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec7 = (0, _inversify.named)(_TYPES["default"].Box), _dec8 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec9 = (0, _inversify.named)(_TYPES["default"].Account), _dec10 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec11 = (0, _inversify.named)(_TYPES["default"].Blue), _dec12 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec13 = (0, _inversify.named)(_TYPES["default"].Check), _dec14 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec15 = (0, _inversify.named)(_TYPES["default"].Interest), _dec16 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec17 = (0, _inversify.named)(_TYPES["default"].Investment), _dec18 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec19 = (0, _inversify.named)(_TYPES["default"].Loan), _dec20 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec21 = (0, _inversify.named)(_TYPES["default"].Movement), _dec22 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec23 = (0, _inversify.named)(_TYPES["default"].Transfer), _dec24 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec25 = (0, _inversify.named)(_TYPES["default"].Usdt), _dec26 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec27 = (0, _inversify.named)(_TYPES["default"].Wire), _dec28 = (0, _inversify.inject)(_TYPES["default"].BoxServiceableDomain), _dec(_class = (_class2 = /*#__PURE__*/function () {
  function Controller() {
    ...
    _initializerDefineProperty(this, "boxSchema", _descriptor4, this);

    _initializerDefineProperty(this, "accountSchema", _descriptor5, this);

    _initializerDefineProperty(this, "blueSchema", _descriptor6, this);

    _initializerDefineProperty(this, "checkSchema", _descriptor7, this);

    _initializerDefineProperty(this, "interestSchema", _descriptor8, this);

    _initializerDefineProperty(this, "investmentSchema", _descriptor9, this);

    _initializerDefineProperty(this, "loanSchema", _descriptor10, this);

    _initializerDefineProperty(this, "movementSchema", _descriptor11, this);

    _initializerDefineProperty(this, "transferSchema", _descriptor12, this);

    _initializerDefineProperty(this, "usdtSchema", _descriptor13, this);

    _initializerDefineProperty(this, "wireSchema", _descriptor14, this);

    _initializerDefineProperty(this, "boxService", _descriptor15, this);
  ...
  writable: true,
  initializer: null
}), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "boxSchema", [_dec6, _dec7], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "accountSchema", [_dec8, _dec9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "blueSchema", [_dec10, _dec11], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "checkSchema", [_dec12, _dec13], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "interestSchema", [_dec14, _dec15], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "investmentSchema", [_dec16, _dec17], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "loanSchema", [_dec18, _dec19], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "movementSchema", [_dec20, _dec21], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, "transferSchema", [_dec22, _dec23], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, "usdtSchema", [_dec24, _dec25], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, "wireSchema", [_dec26, _dec27], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, "boxService", [_dec28], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
