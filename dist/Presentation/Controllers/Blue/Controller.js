...
var Controller = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_TYPES["default"].ConnectionableProvider), _dec3 = (0, _inversify.inject)(_TYPES["default"].Responseable), _dec4 = (0, _inversify.inject)(_TYPES["default"].Validable), _dec5 = (0, _inversify.named)(_TYPES["default"].Blue), _dec6 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec7 = (0, _inversify.named)(_TYPES["default"].Blue), _dec8 = (0, _inversify.inject)(_TYPES["default"].BlueServiceableDomain), _dec(_class = (_class2 = /*#__PURE__*/function () {
  function Controller() {
    var _this = this;
    ...
    _defineProperty(this, "path", '/blue');
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 2:
                ...
                id = request.user._id;
                _context6.next = 7;
                return _this.service.save(objData, model, id).then( /*#__PURE__*/function () {
                          ...
                          case 0:
                            ...
                            return _this.service.getAll(model, {}, {
                              ...
                              if (res.result.length > 0) {
                                ...
                                var ws = XLSX.utils.json_to_sheet(res.result);
                                XLSX.utils.book_append_sheet(wb, ws, 'sheet');
                                XLSX.writeFile(wb, path.join(__dirname, './../../../../uploads/', 'blue.xlsb'));
                              }
                            })["catch"](function (err) {
                              console.log(err);
                            });
