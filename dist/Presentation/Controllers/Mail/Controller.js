...
var Controller = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_TYPES["default"].ConnectionableProvider), _dec3 = (0, _inversify.inject)(_TYPES["default"].Responseable), _dec4 = (0, _inversify.inject)(_TYPES["default"].Validable), _dec5 = (0, _inversify.named)(_TYPES["default"].Mail), _dec6 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec7 = (0, _inversify.named)(_TYPES["default"].Mail), _dec8 = (0, _inversify.inject)(_TYPES["default"].MailServiceableDomain), _dec(_class = (_class2 = /*#__PURE__*/function () {
  function Controller() {
    ...
    (0, _defineProperty2["default"])(this, "sendFile64", /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return base64.encode(path.join(__dirname, './../../../../uploads/', fileName), function (err, base64String) {
                  _this.responserService.res = {
                    result: base64String,
                    message: 'Gestión exitosa',
                    status: 200,
                    error: ''
                  };
    ...
    (0, _defineProperty2["default"])(this, "sendFile", /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(Controller, [{
    ...
    value: function initializeRoutes(validationProvider) {
      this.router.get('/image/:name', [], this.sendFile).get('/image/base64/:name', [], this.sendFile64).get(this.path, [this.authMid.authenticate], this.getAllObjs).get("".concat(this.path, "/schema"), [this.authMid.authenticate], this.getSchema).get("".concat(this.path, "/:id"), [this.authMid.authenticate], this.getObjById).post(this.path, [this.authMid.authenticate, validationProvider.validate(this.dto)], this.saveObj).put("".concat(this.path, "/:id"), [this.authMid.authenticate, validationProvider.validate(this.dto, true)], this.updateObj)["delete"]("".concat(this.path, "/:id"), [this.authMid.authenticate], this.deleteObj);
    }
  }]);
  return Controller;
