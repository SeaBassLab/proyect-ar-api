...
var Controller = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_TYPES["default"].ConnectionableProvider), _dec3 = (0, _inversify.inject)(_TYPES["default"].Responseable), _dec4 = (0, _inversify.inject)(_TYPES["default"].Validable), _dec5 = (0, _inversify.named)(_TYPES["default"].Company), _dec6 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec7 = (0, _inversify.named)(_TYPES["default"].Company), _dec8 = (0, _inversify.inject)(_TYPES["default"].CompanyServiceableDomain), _dec(_class = (_class2 = /*#__PURE__*/function () {
  function Controller() {
    var _this = this;
    ...
    _defineProperty(this, "path", '/company');
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 2:
                ...
                _context8.next = 7;
                return _this.service.getById(id, model).then( /*#__PURE__*/function () {
                  var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(getObjById) {
                    var obj;
  ...
  _createClass(Controller, [{
    ...
    value: function initializeRoutes(validationProvider) {
      this.router.get(this.path, [this.authMid.authenticate], this.getAllObjs).get("".concat(this.path, "/schema"), [this.authMid.authenticate], this.getSchema) //.get(`${this.path}/:id`, [this.authMid.authenticate], this.getObjById)
