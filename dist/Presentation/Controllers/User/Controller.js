...
var Controller = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_TYPES["default"].ConnectionableProvider), _dec3 = (0, _inversify.inject)(_TYPES["default"].Responseable), _dec4 = (0, _inversify.inject)(_TYPES["default"].Validable), _dec5 = (0, _inversify.named)(_TYPES["default"].User), _dec6 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec7 = (0, _inversify.named)(_TYPES["default"].User), _dec8 = (0, _inversify.inject)(_TYPES["default"].UserServiceableDomain), _dec9 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec10 = (0, _inversify.named)(_TYPES["default"].Company), _dec11 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec12 = (0, _inversify.named)(_TYPES["default"].Mail), _dec13 = (0, _inversify.inject)(_TYPES["default"].Schemable), _dec14 = (0, _inversify.named)(_TYPES["default"].Subscription), _dec15 = (0, _inversify.inject)(_TYPES["default"].CompanyServiceableDomain), _dec16 = (0, _inversify.inject)(_TYPES["default"].Authenticable), _dec17 = (0, _inversify.inject)(_TYPES["default"].Authenticable), _dec18 = (0, _inversify.inject)(_TYPES["default"].Controlleable), _dec(_class = (_class2 = /*#__PURE__*/function () {
  ...
  function Controller() {
    ...
    _initializerDefineProperty(this, "mailSchema", _descriptor7, this);

    _initializerDefineProperty(this, "subscriptionSchema", _descriptor8, this);

    _initializerDefineProperty(this, "companyService", _descriptor9, this);

    _initializerDefineProperty(this, "authenticationService", _descriptor10, this);

    _initializerDefineProperty(this, "tokenProvider", _descriptor11, this);

    _initializerDefineProperty(this, "controllerService", _descriptor12, this);

    _defineProperty(this, "storage", _inversify2["default"].get(_TYPES["default"].GeteableCompanyStorage));

    _defineProperty(this, "bulk", /*#__PURE__*/function () {
  ...
  writable: true,
  initializer: null
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "companySchema", [_dec9, _dec10], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "mailSchema", [_dec11, _dec12], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "subscriptionSchema", [_dec13, _dec14], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "companyService", [_dec15], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "authenticationService", [_dec16], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "tokenProvider", [_dec17], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, "controllerService", [_dec18], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
